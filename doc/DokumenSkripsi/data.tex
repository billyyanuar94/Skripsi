...
\judulENG{Thesis Trial Appraisal System 2 using AngularJS}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
%			 bawahnya
%=============================================================================
\abstrakINA{Sistem Penilaian Sidang Skripsi 2 merupakan situs \textit{web} yang membantu penilai dalam melakukan perhitungan dan penyimpanan nilai sidang untuk mata kuliah skripsi 2 pada Program Studi Teknik Informatika Universitas Katolik Parahyangan, Bandung. Sistem Penilaian Sidang Skripsi 2 dibuat menggunakan bahasa PHP yang diintegrasikan dengan AngularJS sehingga dapat melakukan otomatisasi perhitungan nilai akhir mahasiswa.\\
AngularJS merupakan \textit{framework} yang dipakai dalam pembangunan \textit{single page application}. Kemudahan pemakaian AngularJS merupakan salah satu nilai tambah tersendiri. AngularJS memiliki konsep MVC (\textit{Model, View, Controller}) yang membuatnya mudah dipahami. MVC AngularJS sendiri bekerja secara \textit{front-end} sehingga dapat diintegrasikan oleh \textit{framework} lain, seperti \textit{codeigniter}.\\
Pengujian Sistem Penilaian Sidang Skripsi 2 dilakukan dengan membandingkan hasil perhitungan nilai akhir 5 sidang skripsi 2 mahasiswa pada semester ganjil 2016/2017 dari Sistem Penilaian dan dari sistem kini yang masih bersifat \textit{manual}. Berdasarkan hasil pengujian, sistem penilaian memiliki keunggulan dalam pehitungan dibandingkan dengan sistem kini dihitung dari jumlah kesalahan perhitungan.}
\abstrakENG{Thesis Trial Appraisal System 2 is a website design to help assessor in assessment and store the final grade for the course thesis 2 in informatics engineering Parahyangan Catholic University, Bandung. Thesis Trial Appraisal System 2 created using PHP that is integrated with AngularJS so it can perform automatic calculation of the final grade.\\
AngularJS is a framework used in single page application development. Ease of use is one of its own benefit points. AngularJS has a MVC (Model, View, Controller) concept that makes it easier to understand. The MVC of AngularJS work in front-end so it can be integrated with other framework such as codeigniter. \\
Thesis Trial Appraisal System 2 tested by comparing the final grade result in 5 thesis 2 sessions in odd semester of 2016/2017 between the appraisal system and the current manual system. Based on the test result, the appraisal system has an advantage in computation compared to the current manual system that is calculated from the numbers of errors that have been done.} 
%=============================================================================
...
\kunciENG{Thesis Trial Appraisal System 2, PHP, AngularJS}
%=============================================================================
